...
const Really = (props) => {
  ...
  return (
     <div className="content">
      <Header />
      <h1>Me? Really?</h1>
      <p><span className="dropcap">I</span> know what you're thinking. "<em>There is no way I could become a programmer.</em>" OK, let's explore why that might be.</p>

      <p><span class={styles.objection}>I'm not smart enough.</span> I hear that <em>a lot</em>. You probably don't think you're <b>dumb</b>. It's just that to be a programmer, you have to be super-smart, right? There <em>are</em> some super-smart programmers &mdash; people like Linus Torvalds who wrote an entire operating system (Linux). I know those people exist, but in over thirty years of programming, I've never worked with any of them. The truth is you just have to be smart <em>enough</em>. How smart is enough? That's what the Exercises are designed to help you find out.</p>
      ...
      <ul className="">
        ...
        I'm taking a wild guess here that you answered "yes" to all those? Well, then you're not <em>really</em> right-brained, as all those activities are left-brained. The whole left-brain v. right-brain dichotomy was debunked years ago. It's junk science. We have two hemispheres of our brain and we go back and forth between them effortlessly. Do some people have more of an affinity for activities associated with the right hemisphere? Sure, but that doesn't preclude you from employing the left hemisphere when you need to.</p>
      ...
      <p><span className={styles.objection}>I'm a woman and I know programming is a male profession.</span> Do I have news for you! First, yes, programming is predominantly male. Employers (and shareholders) know this too &mdash; and they desperately want to change it. That means that if you're female, you will (a) move to the top of the candidate list and (b) command a higher salary.</p>
